...
$subject ="Новая заявка с сайта Python";
...
$header .= "From: Новая заявка <whightspawn@yandex.ru>\n\n";	
$mail = mail("whightspawn@yandex.ru", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
